...
const DEMO_CARDS = [
  {id:'p1', name:'Charizard ex',            set:'Obsidian Flames',  game:'pokemon',  cat:'raw',    grader:null, grade:null, market:148,  paid:120,  qty:1, folder:'f1', num:'125/197'},
  {id:'p2', name:'Miraidon ex',             set:'Scarlet & Violet', game:'pokemon',  cat:'raw',    grader:null, grade:null, market:88,   paid:72,   qty:2, folder:'f1', num:'081/198'},
  {id:'p3', name:'Mewtwo VSTAR',            set:'Pokémon GO',       game:'pokemon',  cat:'raw',    grader:null, grade:null, market:54,   paid:45,   qty:1, folder:'f1', num:'031/078'},
  {id:'p4', name:'Pikachu ex',              set:'151',              game:'pokemon',  cat:'raw',    grader:null, grade:null, market:38,   paid:30,   qty:3, folder:'f2', num:'001/165'},
  {id:'p5', name:'Blastoise ex',            set:'151',              game:'pokemon',  cat:'raw',    grader:null, grade:null, market:24,   paid:18,   qty:2, folder:'f2', num:'009/165'},
  {id:'p6', name:'Obsidian Flames Box',     set:'Obsidian Flames',  game:'pokemon',  cat:'sealed', grader:null, grade:null, market:165,  paid:140,  qty:2, folder:'f4', num:null},
  {id:'p7', name:'151 Elite Trainer Box',   set:'151',              game:'pokemon',  cat:'sealed', grader:null, grade:null, market:74,   paid:60,   qty:5, folder:'f4', num:null},
  {id:'p8', name:'Paldean Fates ETB',       set:'Paldean Fates',    game:'pokemon',  cat:'sealed', grader:null, grade:null, market:89,   paid:72,   qty:3, folder:'f4', num:null},
  {id:'p9', name:'Charizard Holo 1st Ed',   set:'Base Set',         game:'pokemon',  cat:'slab',   grader:'PSA',grade:9,   market:8500, paid:7200, qty:1, folder:'f3', num:'4/102'},
  {id:'p10',name:'Mewtwo Holo',             set:'Base Set',         game:'pokemon',  cat:'slab',   grader:'PSA',grade:8,   market:620,  paid:510,  qty:1, folder:'f3', num:'10/102'},
  {id:'p11',name:'Charizard ex SAR',        set:'Obsidian Flames',  game:'pokemon',  cat:'slab',   grader:'CGC',grade:10,  market:340,  paid:280,  qty:1, folder:'f3', num:'228/197'},
  {id:'p12',name:'Miraidon ex SAR',         set:'Scarlet & Violet', game:'pokemon',  cat:'slab',   grader:'CGC',grade:9.5, market:190,  paid:155,  qty:1, folder:'f3', num:'245/198'},
  {id:'p13',name:'Umbreon VMAX Alt Art',    set:'Evolving Skies',   game:'pokemon',  cat:'slab',   grader:'BGS',grade:9,   market:280,  paid:240,  qty:1, folder:'f3', num:'215/203'},
  {id:'p14',name:'Rayquaza VMAX Alt Art',   set:'Evolving Skies',   game:'pokemon',  cat:'slab',   grader:'BGS',grade:9.5, market:420,  paid:360,  qty:1, folder:'f3', num:'218/203'},
  {id:'p15',name:'SV 6 Box Case',           set:'Scarlet & Violet', game:'pokemon',  cat:'case',   grader:null, grade:null, market:520,  paid:445,  qty:1, folder:'f4', num:null},
  {id:'o1', name:'Monkey D. Luffy',         set:'OP01 Romance Dawn',game:'onepiece', cat:'raw',    grader:null, grade:null, market:42,   paid:32,   qty:2, folder:'f5', num:'OP01-060'},
  {id:'o2', name:'Roronoa Zoro',            set:'OP01 Romance Dawn',game:'onepiece', cat:'raw',    grader:null, grade:null, market:28,   paid:22,   qty:1, folder:'f5', num:'OP01-001'},
  {id:'o3', name:'Nami Alt Art',            set:'OP01 Romance Dawn',game:'onepiece', cat:'raw',    grader:null, grade:null, market:14,   paid:10,   qty:3, folder:'f5', num:'OP01-016'},
  {id:'o4', name:'Yamato Full Art',         set:'OP04 Kingdoms',    game:'onepiece', cat:'raw',    grader:null, grade:null, market:35,   paid:28,   qty:2, folder:'f6', num:'OP04-110'},
  {id:'o5', name:'Uta Alt Art',             set:'OP02 Paramount',   game:'onepiece', cat:'raw',    grader:null, grade:null, market:22,   paid:16,   qty:4, folder:'f6', num:'OP02-120'},
  {id:'o6', name:'OP01 Booster Box',        set:'OP01 Romance Dawn',game:'onepiece', cat:'sealed', grader:null, grade:null, market:210,  paid:175,  qty:2, folder:'f5', num:null},
  {id:'o7', name:'OP07 Booster Box',        set:'OP07',             game:'onepiece', cat:'sealed', grader:null, grade:null, market:145,  paid:115,  qty:3, folder:'f6', num:null},
  {id:'o8', name:'Luffy PSA 10',            set:'OP01 Romance Dawn',game:'onepiece', cat:'slab',   grader:'PSA',grade:10,  market:380,  paid:310,  qty:1, folder:'f7', num:'OP01-060'},
  {id:'o9', name:'Zoro Alt Art CGC 10',     set:'OP01 Romance Dawn',game:'onepiece', cat:'slab',   grader:'CGC',grade:10,  market:290,  paid:245,  qty:1, folder:'f7', num:'OP01-001'},
  {id:'o10',name:'Shanks Parallel PSA 9',   set:'OP04 Kingdoms',    game:'onepiece', cat:'slab',   grader:'PSA',grade:9,   market:180,  paid:150,  qty:1, folder:'f7', num:'OP04-040'},
  {id:'o11',name:'Boa Hancock Full Art',    set:'OP02 Paramount',   game:'onepiece', cat:'slab',   grader:'BGS',grade:9.5, market:95,   paid:78,   qty:1, folder:'f7', num:'OP02-104'},
  {id:'o12',name:'OP01 Display Case',       set:'OP01 Romance Dawn',game:'onepiece', cat:'case',   grader:null, grade:null, market:320,  paid:265,  qty:1, folder:'f5', num:null},
];
const DEMO_ACCOUNTS = {
...
const DEMO_COLLECTION = {
  portfolios:[
    {id:'cp1',name:'My Main Collection',game:'pokemon', listed:false},
    {id:'cp2',name:'One Piece Hits',    game:'onepiece',listed:false},
  ],
  cards:[
    {id:'cc1',name:'Charizard ex',        set:'Obsidian Flames',  game:'pokemon', cat:'raw',   grader:null,grade:null,market:148,paid:130,qty:1,portfolio:'cp1',num:'125/197'},
    {id:'cc2',name:'Umbreon VMAX Alt Art',set:'Evolving Skies',   game:'pokemon', cat:'slab',  grader:'PSA',grade:9,  market:280,paid:240,qty:1,portfolio:'cp1',num:'215/203'},
    {id:'cc3',name:'151 ETB',             set:'151',              game:'pokemon', cat:'sealed',grader:null,grade:null,market:74, paid:65, qty:2,portfolio:'cp1',num:null},
    {id:'cc4',name:'Monkey D. Luffy',     set:'OP01 Romance Dawn',game:'onepiece',cat:'raw',   grader:null,grade:null,market:42, paid:35, qty:1,portfolio:'cp2',num:'OP01-060'},
    {id:'cc5',name:'Yamato Full Art',     set:'OP04 Kingdoms',    game:'onepiece',cat:'raw',   grader:null,grade:null,market:35, paid:28, qty:2,portfolio:'cp2',num:'OP04-110'},
  ]
};
...
const S = {
  ...
  ui:{
    ...
    adminTab:'pricing', chartRange:30,
  },
...
const CardImages = {
  ...
  async _pokemon(card) {
    ...
    if (!setCode || !card.num) return null;
    const rawNum = card.num.split('/')[0];
    if (!/^\d+$/.test(rawNum)) return null;
    const num = parseInt(rawNum, 10);
    const cacheKey = `${setCode}-${num}`;
    if (this._apiCache[cacheKey] !== undefined) return this._apiCache[cacheKey];
    try {
      const res = await fetch(
        `https://api.pokemontcg.io/v2/cards?q=set.id:${setCode}+number:${num}&select=id,images`,
      ...
      // Fallback: direct CDN
      const url = `https://images.pokemontcg.io/${setCode}/${num}_hires.png`;
      this._apiCache[cacheKey] = url;
      return url;
    }
  },
  ...
  cards.forEach(card => {
    CardImages.get(card).then(url => {
      ...
      const grids = gridId
        ...
        : ['grid-home','grid-pokemon','grid-onepiece','collectionList'].map(id => document.getElementById(id));
      grids.forEach(grid => {
        if (!grid) return;
...
const TICKERS = [
  ...
  {n:'Umbreon VMAX BGS 9',p:280,d:'dn',pct:'-1.2%',g:'poke',i:'🏆'},
...
function updateFolderSelects() {
  ['poke-fsel','op-fsel'].forEach(sid => {
    ...
    const folders = S.store.folders.filter(f => f.game===game && f.enabled);
    const val = sel.value;
...
function renderGrid(game) {
  const ui = S.ui[game];
  const enabledFolders = new Set(S.store.folders.filter(f=>f.game===game&&f.enabled).map(f=>f.id));
...
async function loadPriceChart(card, days) {
  ...
  const base = card.market;
  const seed = (card.id||'').split('').reduce((a,c)=>a+c.charCodeAt(0),0);
  let price  = base*(0.78+((seed%20)/100));
  const rng  = i => ((Math.sin(seed*i+i)+1)/2);
  const pts  = [];
  for (let i=days;i>=0;i--) {
    price += price*(rng(i)-0.47)*0.045;
  ...
  grad.addColorStop(0, trend?'rgba(22,163,74,0.2)':'rgba(220,38,38,0.2)');
  grad.addColorStop(1,'rgba(0,0,0,0)');
  S.priceChart = new Chart(ctx, {
    type:'line',
    data:{labels,datasets:[{data,borderColor:color,borderWidth:2,backgroundColor:grad,fill:true,tension:0.42,pointRadius:0,pointHoverRadius:5,pointHoverBackgroundColor:color}]},
    options:{
      responsive:true,maintainAspectRatio:false,
      plugins:{legend:{display:false},tooltip:{mode:'index',intersect:false,backgroundColor:'#1A2744',borderColor:'rgba(43,92,230,0.3)',borderWidth:1,titleColor:'#6B7A99',bodyColor:'#fff',callbacks:{label:c=>`${fmt(c.raw)}`}}},
      scales:{x:{display:false},y:{display:true,grid:{color:'rgba(43,92,230,0.06)'},ticks:{color:'#6B7A99',font:{family:'Nunito',size:10,weight:'700'},callback:v=>fmt(v,0)}}}
    }
  });
}
...
function renderCollection() {
  ...
  tabsRow.innerHTML = portfolios.map(p => {
    ...
    return `<button class="port-tab ${active?'active':''}" onclick="setActivePortfolio('${p.id}')">
      ${p.game==='pokemon'?'⚡':p.game==='onepiece'?'⚓':'🎴'} ${p.name}
...
function renderCollectionCards() {
  ...
  if (port) {
    ...
    const gameColor = port.game==='pokemon'?'#FFF3CD':port.game==='onepiece'?'#DBEAFE':'#F3E8FF';
    const gameText  = port.game==='pokemon'?'#92400E':port.game==='onepiece'?'#1E3A8A':'#4C1D95';
    const gameLabel = port.game==='pokemon'?'⚡ Pokémon':port.game==='onepiece'?'⚓ One Piece':'🎴 Mixed';
    headerHtml = `<div class="coll-portfolio-header">
      <div class="cph-left">
        <div class="cph-title">${port.name}</div>
        <span class="cph-game-badge" style="background:${gameColor};color:${gameText}">${gameLabel}</span>
  ...
  container.innerHTML = headerHtml+`<div class="coll-cards-grid">${showCards.map(c=>renderCollTile(c)).join('')}</div>`;
...
function togglePortfolioListed(portId) {
  ...
  if (p.listed) {
    ...
    if (!S.store.folders.find(f=>f.id===portId)) {
      S.store.folders.push({id:portId,name:p.name,game:p.game,enabled:true,premiumPct:5,premiumFlat:0});
...
function showAddToCollection(cardId) {
  ...
  picker.innerHTML = S.collection.portfolios.map(p=>{
    ...
    return `<div class="plp-item ${S.pendingPortfolio===p.id?'selected':''}" onclick="selectPortfolio('${p.id}',this)">
      <span class="plp-name">${p.game==='pokemon'?'⚡':p.game==='onepiece'?'⚓':'🎴'} ${p.name}</span>
...
function createPortfolio() {
  ...
  const game = document.getElementById('newPortGame').value;
  ...
  S.collection.portfolios.push({id,name,game,listed:false});
...
async function searchJustTCG() {
  ...
  const seen = new Set();
  const results = [...S.store.cards,...S.collection.cards].filter(c=>{
    if (seen.has(c.name+'::'+c.set)) return false; seen.add(c.name+'::'+c.set);
    const ql=q.toLowerCase(); return c.name.toLowerCase().includes(ql)||c.set.toLowerCase().includes(ql);
  }).slice(0,10).map(c=>({id:c.id,name:c.name,set:c.set,game:c.game,market:c.market,num:c.num,cat:c.cat}));
  if (!results.length) {
    list.innerHTML=`<div style="text-align:center;padding:.75rem;font-size:.78rem;color:var(--muted);">No matches for "${q}"</div>
      <div class="sr-item" onclick="selectCustomCard('${q.replace(/'/g,"\\'")}')"><span>✏️ Add "${q}" as custom card</span></div>`;
    return;
  }
  window._searchResults = results;
  list.innerHTML = results.map((r,i)=>
    `<div class="sr-item" onclick="selectSearchCard(window._searchResults[${i}])">
      <span>${r.game==='pokemon'?'⚡':'⚓'} <strong>${r.name}</strong> <span style="font-size:.72rem;color:var(--muted);">${r.set}</span></span>
      <span class="sr-price">${r.market?fmt(r.market):'—'}</span></div>`
  ).join('')+`<div class="sr-item" onclick="selectCustomCard('${q.replace(/'/g,"\\'")}')"><span>✏️ Add custom card</span></div>`;
}
...
function selectSearchCard(card) {
  ...
  const setRow=document.getElementById('mSetRow'); if(setRow) setRow.remove();
  document.getElementById('searchResultList').innerHTML='';
  document.getElementById('selectedCardPreview').innerHTML=`<strong>${card.game==='pokemon'?'⚡':'⚓'} ${card.name}</strong> · ${card.set}${card.num?' · '+card.num:''} · <span style="color:var(--red);font-weight:900;">${card.market?fmt(card.market):'—'}</span>`;
  document.getElementById('manualFormArea').style.display='';
}
function confirmManualAdd() {
  ...
  const port=S.collection.portfolios.find(p=>p.id===portId);
  const game=S.manualCard.id?S.manualCard.game:(port?.game==='onepiece'?'onepiece':'pokemon');
  S.collection.cards.push({id:'cc'+Date.now(),name:S.manualCard.name,set:setName,num:S.manualCard.num||'',game,cat,grader,grade,market:S.manualCard.market||0,paid,qty,portfolio:portId});
  S.manualCard=null;
  document.getElementById('manualFormArea').style.display='none';
  document.getElementById('manualSearch').value='';
  document.getElementById('searchResultList').innerHTML='';
