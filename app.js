...
const DEMO_CARDS = [
  // ── Pokémon · SV Promos & Specials (folder f1) ──
  // Charizard ex 125/197 Double Rare — peaked at launch, market ~$18 raw in 2025
  ...
  // Miraidon ex 081/198 Double Rare — declined significantly since SVI launch
  ...
  // Mewtwo VSTAR from Pokémon GO set
  ...
  // ── Pokémon · Vintage Holos (folder f2) ──
  // Pikachu ex from MEW (151) — set uses national dex numbering, Pikachu = 025
  {id:'p4', name:'Pikachu ex',              set:'151',              game:'pokemon',  cat:'raw',    grader:null, grade:null, market:14,   paid:25,   qty:3, folder:'f2', num:'025/165'},
  // Blastoise ex from MEW (151) — national dex 009
  {id:'p5', name:'Blastoise ex',            set:'151',              game:'pokemon',  cat:'raw',    grader:null, grade:null, market:8,    paid:14,   qty:2, folder:'f2', num:'009/165'},
  // ── Pokémon · Sealed (folder f4) ──
  {id:'p6', name:'Obsidian Flames Booster Box',set:'Obsidian Flames',game:'pokemon', cat:'sealed', grader:null, grade:null, market:90,  paid:95,   qty:2, folder:'f4', num:null},
  {id:'p7', name:'151 Elite Trainer Box',   set:'151',              game:'pokemon',  cat:'sealed', grader:null, grade:null, market:60,   paid:55,   qty:5, folder:'f4', num:null},
  {id:'p8', name:'Paldean Fates ETB',       set:'Paldean Fates',    game:'pokemon',  cat:'sealed', grader:null, grade:null, market:50,   paid:45,   qty:3, folder:'f4', num:null},
  // ── Pokémon · Graded Hits (folder f3) ──
  // Base Set Charizard Holo 1st Edition PSA 9
  {id:'p9', name:'Charizard Holo 1st Edition',set:'Base Set',       game:'pokemon',  cat:'slab',   grader:'PSA',grade:9,   market:10200,paid:7200, qty:1, folder:'f3', num:'4/102'},
  {id:'p10',name:'Mewtwo Holo',             set:'Base Set',         game:'pokemon',  cat:'slab',   grader:'PSA',grade:8,   market:480,  paid:420,  qty:1, folder:'f3', num:'10/102'},
  // 228/197 = Special Illustration Rare (SIR) — English name for what Japan calls SAR
  {id:'p11',name:'Charizard ex SIR',        set:'Obsidian Flames',  game:'pokemon',  cat:'slab',   grader:'CGC',grade:10,  market:380,  paid:310,  qty:1, folder:'f3', num:'228/197'},
  // 245/198 = Special Illustration Rare (SIR)
  {id:'p12',name:'Miraidon ex SIR',         set:'Scarlet & Violet', game:'pokemon',  cat:'slab',   grader:'CGC',grade:9.5, market:75,   paid:130,  qty:1, folder:'f3', num:'245/198'},
  ...
  {id:'p14',name:'Rayquaza VMAX Alt Art',   set:'Evolving Skies',   game:'pokemon',  cat:'slab',   grader:'BGS',grade:9.5, market:420,  paid:350,  qty:1, folder:'f3', num:'218/203'},
  // ── Pokémon · Cases (folder f4) ──
  {id:'p15',name:'Stellar Crown Booster Case',set:'Stellar Crown',  game:'pokemon',  cat:'case',   grader:null, grade:null, market:440,  paid:400,  qty:1, folder:'f4', num:null},
  // ── One Piece · OP01 Romance Dawn (folder f5) ──
    ...
    CardImages.get(card).then(url => {
      ...
      grids.forEach(grid => {
        ...
        grid.querySelectorAll(`[data-card-id="${card.id}"] .thumb`).forEach(thumb => {
          ...
          // One Piece: try multiple CDN URL patterns before giving up
